...
MainMenuState.prototype.menu = 0;
MainMenuState.prototype.backgroundImage = 0;
MainMenuState.prototype.buttonImage = 0;
MainMenuState.prototype.buttonImage = 0;
...
function MainMenuState() {
	...
	this.menu.x = (_screenWidth*0.05)|0;
	this.menu.y = (_screenWidth*0.185)|0;

}

MainMenuState.prototype = new GameState();
MainMenuState.prototype.constructor = MainMenuState;
MainMenuState.prototype.menu = {
	x: 32, y: 120,		// set in main_setResolution()
	activeIndex: -1,
...
MainMenuState.prototype.input = function(e) {
	switch(e.type) {
		case "mousemove":
			break;
		case "keydown":
